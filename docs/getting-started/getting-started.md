...
More information can be found [here](https://github.com/citrineos/citrineos-core#information-on-docker-setup). You can access the following services at the specified URLs:
...
| **GraphQL Engine**                    | [http://localhost:8090](http:///localhost:8090)                                              | The Hasura GraphQL engine to support GraphQL operations against the database. You can view the console at [http://localhost:8090/console](http://localhost:8090/console).                                      |
